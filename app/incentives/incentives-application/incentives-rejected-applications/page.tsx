...
const IncentivesRejectedApplications = () => {
    ...
    <div className="flex max-w-md min-h-screen flex-col">
      ...
      <main className="flex flex-1 flex-col bg-gray-50 text-black">
          ...
          <div className="flex relative mx-5 my-5">
            ...
            className="p-3"
            >
              <option value="all-applications">Rejected Applications</option>
              <option value="approved">Approved Applications</option>
              <option value="rejected">All Applications</option>
            </select>
          </div>
...
export default IncentivesRejectedApplications;