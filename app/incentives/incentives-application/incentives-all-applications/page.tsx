...
const IncentivesAllApplications = () => {
              ...
              <tbody>
                <tr>
                  ...
                  <td className="py-4 pr-4 pl-4 align-top">
                    ...
                    <p className="text-red-500 text-md mt-3">Not verified</p>
          ...
          <div className="w-full bg-white">
            <table>
              <tbody>
                <tr>
                  <td className="py-5">
                    <Image className="rounded-lg ml-2" src="/images/incentives/notification-bell.png" alt="Logo" width={50} height={50} />
                  </td>
                  <td className="py-5 pr-5 pl-5 align-top">
                    <h1 className="text-lg truncate w-60"><b>Notifications</b></h1>
                    <h1 className="text-lg truncate w-60"><b>Hand-pane Doors Installation</b></h1>
                  </td>
                  <td className="py-5">
                    <button
                      type="submit"
                      className="w-20 bg-blue-500 text-white rounded-full p-2 font-medium hover:bg-blue-600 transition"
                      >
                        12 new
                      </button>
                  </td>
...
export default IncentivesAllApplications;