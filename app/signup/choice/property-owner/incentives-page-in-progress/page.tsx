...
const IncentivesPageInProgress = () => {
                ...
                <tbody>
                    <tr>
                      <td>
                        ...
                        style={{ width: '18px', height: '12px', borderRadius: '20%', backgroundColor: "gold"}}>
                        </div>
                      </td>
                      <td className="px-3">
                        <p style={contentFontSize}>Applied: In Progress</p>
                      </td>
                    </tr>
                </tbody>
...
export default IncentivesPageInProgress;